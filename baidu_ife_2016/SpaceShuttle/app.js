...
(function() {
    ...
    //根据id号来构造飞船  var ship1 = new Spaceship(1);
    ...
    //动力系统 prototype为spaceship类不断新增方法 层叠添加 dynamicManager.stop()?
    Spaceship.prototype.dynamicManager = function() {
        ...
        var fly = function() {
            self.timer = setInterval(function() {
                ...
                AnimUtil.fly(self.id, self.deg);    //动画方法与后台数据分离
            }, 20);
        ...
        return {  //返回一个对象 如此调用 ship1.dynamicManager.stop() 具体实现private化 
            fly: fly,
            stop: stop
        };
    };
